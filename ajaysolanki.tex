...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \item Designed and implemented scalable system architectures for multiple projects. Developed projects using Angular, React, Node, Exrpess, Redux, Redux-toolkit, Material UI .
...
\resumeProject
  {Maal Banking System - Micro Finance Bank  {{}[\href{https://maalbanking.com/}{\textcolor{darkblue}{\faGlobe}}]}}
  {Tools: Angular, Material, Python3, Django, Django Rest Framework, PostgreSQL, Microservices, Nginx}
  {}{}
  
\resumeItemListStart
  \item Maal is a Bank Application mostly used in Nigeria, SA. This application is used for managing the Administration workflow related to the TAJ Bank. 
...
\resumeProject
  {Cowrie - Cryptocurrency Exchange {{}[\href{https://www.mycowrie.org/login}{\textcolor{darkblue}{\faGlobe}}]} }
...
\resumeProject
  {Yasa Student App {{}[\href{https://student.getyasa.com/login}{\textcolor{darkblue}{\faGlobe}}]} }
  {Tools: React Js, Node Js, Express Js, MongoDB, BootStrap}
  {}{}
\resumeItemListStart
  \item Yasa Student App is a comprehensive platform designed to facilitate seamless connections between students and teachers for online classes. 
